  ...
  dualOffers: {
    optionA: {
      ...
      features: [
        ...
        { label: "LLM Groq (vraie conversation)", included: true },
        ...
        { label: "Pré-remplissage du formulaire de devis", included: false },
    ...
    optionB: {
      name: "Option B — Complète",
      price: "15 000 $",
      priceValue: 15000,
      timeline: "5–7 semaines",
      estimatedHours: "27–30h",
      infraCost: "< 25$ USD/mois",
      featured: true,
      description: "L'agent devient un commercial IA spécialisé transport, disponible 24/7. Il qualifie les prospects avec l'expertise d'un vrai représentant Safex et route les leads directement vers l'équipe.",
      features: [
        { label: "Widget chips Q1/Q2/Q3", included: true },
        { label: "LLM Groq (vraie conversation)", included: true },
        { label: "Bilingue EN / FR", included: true },
    ...
    recommendation: "L'Option A livre un agent IA complet et fonctionnel — vrai LLM, analytics, dashboard — pour un budget accessible. L'Option B pousse la logique commerciale beaucoup plus loin : l'agent ne se contente pas de naviguer, il qualifie les prospects avec l'expertise d'un vrai commercial transport et alerte l'équipe Safex en temps réel.",
  },
}
