...
**RULE 4 — Slides beyond the 8 required**
...
You must always generate these 8 sections in this order:
...
6. Banque d'heures → `pricing-slide.tsx`
7. Annexe → `annexe-slide.tsx`
8. Closing / projection stratégique → `closing-slide.tsx`
...
#### SLIDE 6 : Tarification (`pricing-slide.tsx`)
...
#### SLIDE 7 : Annexe (`annexe-slide.tsx`)
...
#### SLIDE 8 : Closing (`closing-slide.tsx`)
