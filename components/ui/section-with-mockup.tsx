...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({
    ...
    return (
        <section className={`relative py-24 md:py-32 overflow-hidden ${className}`} style={{ backgroundColor: bgColor }}>
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <div className="text-white/60 text-sm md:text-[15px] leading-6">
                            {description}
                        </div>
                    ...
                    {(primaryImageSrc || secondaryImageSrc) && (
                      ...
                      >
                          ...
                          {primaryImageSrc && (
                            <motion.div
                                className="relative w-full h-[405px] md:h-[637px] bg-[#ffffff0a] rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border border-white/10 z-10 overflow-hidden"
                                initial={{ y: reverseLayout ? 0 : 0 }}
                                whileInView={{ y: reverseLayout ? 20 : 30 }}
