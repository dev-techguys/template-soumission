  ...
  return (
    <SlideWrapper id="about-us" className="bg-white">
      <div className="max-w-6xl mx-auto px-8 py-20 w-full">
        ...
        {/* Pillars */}
        <AnimatedContainer staggerDelay={0.15} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {PILLARS.map((pillar) => (
            <AnimatedItem key={pillar.title}>
              <div className="group relative p-8 rounded-xl border border-[#e5e7eb] bg-white hover:border-[#ff7000]/30 hover:shadow-lg transition-all duration-500 h-full">
