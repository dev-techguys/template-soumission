      ...
      <div className={`relative h-full p-6 overflow-hidden ${
        ...
        {option.recommended && (
          <div className="absolute -top-px left-1/2 -translate-x-1/2">
            <div className="flex items-center gap-1.5 px-4 py-1.5 bg-gradient-to-r from-[#0066FF] to-[#3388FF] rounded-b-xl">
          ...
          <div className="flex items-start gap-4 mb-4">
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${
              option.recommended 
                ...
                : "bg-white/5 border border-white/10 group-hover:border-[#0066FF]/30 transition-colors"
            }`}>
  ...
  return (
    <SlideWrapper id="roadmap" className="relative">
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 py-24 w-full">
        ...
        {/* Recommendation note */}
        <div className="mt-12 glass-card p-6 border-[#0066FF]/20">
