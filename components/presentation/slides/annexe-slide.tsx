...
import { Check, BookOpen, Code, Database, Shield, AlertTriangle } from "lucide-react"
    ...
    <SlideWrapper id="annexe" className="bg-[#f8fafc] !min-h-0">
      <div className="max-w-5xl mx-auto px-8 py-20 w-full">
        ...
        <Accordion type="multiple" className="flex flex-col gap-4">
          ...
          {/* Upgrade note */}
          <div className="px-6 md:px-8 py-6 rounded-xl border border-[#10B981]/30 bg-[#10B981]/5 flex items-start gap-4 shadow-sm">
            ...
            <div className="flex flex-col gap-1">
              <h3 className="font-serif text-lg md:text-xl text-[#0f172a]">
                {"Upgrade A → B possible"}
              </h3>
              <p className="text-sm text-[#64748b] font-sans leading-relaxed">
                {"L'Option A est upgradeable vers l'Option B. Les features manquantes sont des modules indépendants — elles peuvent être ajoutées après le lancement de l'Option A sans refonte de l'architecture de base. Si les 3 premiers mois de données (dashboard Option A) montrent un volume de conversations qui justifie l'upgrade, TechGuys livre le delta en phase 2."}
              </p>
            </div>
          </div>
        </Accordion>
